    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('wifi', 'Free Wi-Fi'), ('pool', 'Swimming Pool'), ('parking', 'Free Parking'), ('gym', 'Gym/Fitness Center'), ('restaurant', 'Restaurant On-Site'), ('spa', 'Spa & Sauna'), ('shuttle', 'Airport Shuttle'), ('conference', 'Conference Room'), ('laundry', 'Laundry Service')], max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('owner', 'Owner'), ('staff', 'Staff'), ('tour_guide', 'Tour Guide'), ('customer_support', 'Customer Support'), ('marketing', 'Marketing')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='managed_hotels', to='main.admin')),
            ],
            options={
                'verbose_name': 'Hotel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conversation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='main.conversationdm')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField()),
                ('sent_at', models.DateTimeField(auto_now_add=True)),
                ('conversation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='main.groupchatconversation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(max_length=50)),
                ('city', models.CharField(max_length=50)),
                ('discount', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(49)])),
        ...
        migrations.AddField(
            ...
            name='trip',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='group_chat', to='main.trip'),
        ),
        migrations.AddField(
            model_name='customer',
            name='favorite_trips',
        ...
        migrations.AddConstraint(
            model_name='hotel',
            constraint=models.UniqueConstraint(fields=('name', 'created_by'), name='unique_hotel_signature'),
        ),
        migrations.AddConstraint(
            model_name='conversationdm',
            constraint=models.UniqueConstraint(fields=('staff', 'cust'), name='conversation'),
        ),
        migrations.AddConstraint(
            model_name='trip',
