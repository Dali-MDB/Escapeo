...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='conversationdm',
            name='ticket',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='conversation', to='main.supportticket'),
        ),
        migrations.CreateModel(
            name='Trip',
            fields=[
        ...
        migrations.AddConstraint(
            model_name='conversationdm',
            constraint=models.UniqueConstraint(condition=models.Q(('ticket__isnull', False)), fields=('staff', 'cust', 'ticket'), name='unique_conversation'),
        ),
        migrations.AddConstraint(
            model_name='conversationdm',
            constraint=models.UniqueConstraint(condition=models.Q(('ticket__isnull', True)), fields=('staff', 'cust'), name='unique_direct_conversation'),
        ),
        migrations.AddConstraint(
            model_name='trip',
